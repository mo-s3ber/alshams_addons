...
class SubcontractReport(models.Model):
    ...
    _description = "Subcontract Report"
    _auto = False
    ...
    user_id = fields.Many2one('res.users', 'Subcontract Representative', readonly=True)
    ...
    negociation = fields.Float('Surchase-Standard Price', readonly=True, group_operator="avg")
    ...
    def _from(self):
        from_str = """
            subcontract_order_line l
                join subcontract_order s on (l.order_id=s.id)
