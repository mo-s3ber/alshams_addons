odoo.define('adding_analytic_account.analytic_account_id', function (require) {
"use strict";
    ...
    reconciliation_model.StatementModel.include({
        _formatToProcessReconciliation: function (line, prop) {
            ...
            if (prop.analytic_account_id){
                console.log(prop.analytic_account_id, '-prop.analytic_account_id-');
                result.analytic_account_id = prop.analytic_account_id.id
            }else if(line.analytic_account_id){
                console.log(line.analytic_account_id, '-line.analytic_account_id-');
